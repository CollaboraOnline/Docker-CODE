...
perl -pi -e "s/de_DE en_GB en_US es_ES fr_FR it nl pt_BR pt_PT ru<\/allowed_languages>/de_DE en_GB en_US es_ES fr_FR it nl pt_BR pt_PT ru ${add_dictionaries}<\/allowed_languages>/g" /etc/loolwsd/loolwsd.xml
